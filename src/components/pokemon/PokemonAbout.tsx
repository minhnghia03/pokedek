      ...
      <div className="flex gap-6">
        <div className="flex flex-col items-center gap-2 justify-end">
          <div className="flex items-center gap-2">
            ...
            <h1>{pokemon.weight} kg</h1>
          </div>
          <h1 className="text-sm text-mediumGray">Weight</h1>
        </div>

        <div className="w-[2px] bg-lightGray" />
        ...
        <div className="flex flex-col items-center gap-2 justify-end">
          <div className="flex items-center gap-2">
            ...
            <h1>{pokemon.height} m</h1>
          </div>
          <h1 className="text-sm text-mediumGray">Height</h1>
        </div>
